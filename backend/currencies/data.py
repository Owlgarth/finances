"""Active ISO 4217 currency list used to seed the global catalog.

decimals is the ISO minor-unit exponent (JPY=0, KWD/BHD/OMR=3, most=2).
Where a currency has no widely recognized symbol, the code is used as the symbol.
"""
...
ISO_4217: list[dict] = [
    ...
    {'code': 'UZS', 'name': 'Uzbekistani Som', 'symbol': 'сўм', 'decimals': 2},
