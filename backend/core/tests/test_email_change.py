...
class TestRequestEmailChange(AuthTestCase):
    def test_request_email_change_sends_verification(self):
    ...
    def test_request_email_change_uppercase_normalized(self):
...
class TestConfirmEmailChange(AuthTestCase):
    ...
    def test_confirm_email_change_email_now_taken(self):
        token, user = self._setup_user_with_pending_email()
