...
Paste this into every Owlgarth Finances project. Uses CSS custom properties so dark mode works automatically — see `dark-mode.md` for the variable overrides.
