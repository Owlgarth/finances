...
**Template notification subject:** `GDPR Data Breach Notification - Owlgarth Finances - [Date]`
...
**Template subject:** `Important: Security Notice Regarding Your Owlgarth Finances Account`
