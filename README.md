...
Use, host, modify, sell it freely. Just keep the footer link if other people can see your instance.

See [LICENSE](LICENSE) for the full terms (Apache 2.0 with attribution condition).
